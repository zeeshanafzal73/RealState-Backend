...
from .serializers import RegisterSerializer, LoginSerializer, LatestProperty, TeamSerializer, NewsSerializer, AboutSerializer, AgentSerializer, MessagesSerializer, ContactUsSerializer, PasswordResetSerializer
